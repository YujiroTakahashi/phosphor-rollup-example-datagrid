...
class LargeDataModel extends datagrid.DataModel {
...
class StreamingDataModel extends datagrid.DataModel {
    ...
    constructor() {
        ...
        this._tick = () => {
            ...
            if ((r1 < 0.45 && nr > 4) || nr >= 500) {
                ...
                this._data.splice(i, 0, this.createRow(nc));
...
class RandomDataModel extends datagrid.DataModel {
...
const heatMapViridisInverse = ({ value }) => {
...
function createWrapper(content, title) {
    let wrapper = new widgets.StackedPanel();
...
window.onload = () => {
    ...
    let model5 = new datagrid.JSONModel(Data.cars);

    let blueStripeStyle = __assign({},
        datagrid.DataGrid.defaultStyle, {
        rowBackgroundColor: function (i) { return i % 2 === 0 ? 'rgba(138, 172, 200, 0.3)' : ''; },
        columnBackgroundColor: function (i) { return i % 2 === 0 ? 'rgba(100, 100, 100, 0.1)' : ''; }
    });

    let brownStripeStyle = __assign({},
        datagrid.DataGrid.defaultStyle, {
        columnBackgroundColor: function (i) { return i % 2 === 0 ? 'rgba(165, 143, 53, 0.2)' : ''; }
    });

    let greenStripeStyle = __assign({},
        datagrid.DataGrid.defaultStyle, {
        rowBackgroundColor: function (i) { return i % 2 === 0 ? 'rgba(64, 115, 53, 0.2)' : ''; }
    });

    let fgColorFloatRenderer = new datagrid.TextRenderer({
        font: 'bold 12px sans-serif',
        textColor: redGreenBlack,
        format: datagrid.TextRenderer.formatFixed({ digits: 2 }),
        horizontalAlignment: 'right'
    });

    let bgColorFloatRenderer = new datagrid.TextRenderer({
    ...
    let grid1 = new datagrid.DataGrid({ style: blueStripeStyle });
    grid1.model = model1;

    let grid2 = new datagrid.DataGrid({ style: brownStripeStyle });
    grid2.model = model2;

    let grid3 = new datagrid.DataGrid();
    grid3.cellRenderers.set('body', {}, fgColorFloatRenderer);
    grid3.model = model3;

    let grid4 = new datagrid.DataGrid();
    grid4.cellRenderers.set('body', {}, bgColorFloatRenderer);
    grid4.model = model4;

    let grid5 = new datagrid.DataGrid({
    ...
    widgets.Widget.attach(dock, document.body);
}
